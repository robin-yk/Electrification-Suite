...
rows=[json.loads(l) for f in sorted(glob.glob(
    HERE + '/data/wide/design-wide-final3-w*.jsonl')) for l in open(f)]
...
json.dump(report, open(HERE + '/data/wide/final3-test-report.json','w'), indent=1)
print("wrote final3-test-report.json")
