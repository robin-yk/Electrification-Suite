...
// doesn't treat as an asset reference either. joule-solver.js is only reached
// through joule.html's own <script type="module" src>, and since joule.html
// itself is copied raw (never parsed as an HTML entry), Vite never sees that
// reference either — it needs the same explicit copy.
const projectPages = ["microwave.html", "joule.html", "joule-solver.js", "rphcjh.html", "Yeonsu-Kwak-CV.pdf"];
